...
describe('AppComponent', () => {
  ...
  it(`should have as title 'medCare'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    expect(app.title).toEqual('medCare');
  });
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('.content span')?.textContent).toContain('medCare app is running!');
  });
});
